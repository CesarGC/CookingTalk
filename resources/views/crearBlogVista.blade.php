...
<div id="mainVistaCrearBlog">
	<header class="headerPerfil w3-animate-top">
		<div class="headerTitle w3-panel w3-light-grey w3-border w3-round w3-text-blue w3-border-blue"><h1>Nuevo Blog</h1></div>
	...
	<div id="contenedorCreacionBlog" class="w3-container w3-card-4 w3-light-grey w3-animate-bottom">
		...
		<div class="w3-third w3-animate-left w3-padding-right">
			<p>
				...
				'class' => 'campoCreacionBlog w3-padding-top w3-padding-bottom w3-border-bottom w3-border-top w3-border-blue w3-white w3-margin-bottom',
				'id' => 'newContenidoBlog',
				'value' => 'modificar'
				)) }}

				{{ Form::file('foto2', array(
				'class' => 'campoCreacionBlog w3-padding-top w3-padding-bottom w3-border-bottom w3-border-top w3-border-blue w3-white w3-margin-bottom',
				'id' => 'newContenidoBlog2',
				'value' => 'modificar'
				)) }}

				{{ Form::file('foto2', array(
				'class' => 'campoCreacionBlog w3-padding-top w3-padding-bottom w3-border-bottom w3-border-top w3-border-blue w3-white w3-margin-bottom',
				'id' => 'newContenidoBlog3',
				'value' => 'modificar'
				)) }}
			</p>
		</div>
...
<div id="contenedorBtnCrearBlog">
	<button type="submit" id="btnCrearBlog" class="w3-btn w3-round w3-deep-orange"><i class="fa fa-check-circle-o fa-3x itemCrearBlog" aria-hidden="true"></i><span class="itemCrearBlog">Crear Blog</span></Button>
	</div>
	{{ Form::close() }}
</div>
</div>
